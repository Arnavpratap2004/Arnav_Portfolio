                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 pt-4">
                                <SocialIcon
                                    ...
                                    ariaLabel="LinkedIn — Arnav Pratap"
                                >
...
const SocialIcon = ({ href, children, pulseDelay, hoverColor, ariaLabel }: SocialIconProps) => {
    const [isPulsing, setIsPulsing] = useState(false);
    ...
    return (
        <a
            ...
            className={cn(
                ...
                isHovered
                    ? `bg-gradient-to-r ${hoverColor} scale-110`
                    : "bg-neutral-800",
                isPulsing && !isHovered && "scale-[1.03]"
            )}
